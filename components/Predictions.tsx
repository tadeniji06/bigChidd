...
const Predictions = () => {
	const [predictions] = useState([
		...
		},
		{
			...
			comment: "Multiple Draw Accumulator",
			match: {
				homeTeam: "Cariari Pococi",
				awayTeam: "Santa Ana",
				utcDate: "2025-10-08T21:00:00Z",
				status: "PENDING",
				finalResult: null,
			},
		},
		{
			...
			match: {
				...
				awayTeam: "Ind. Medellin",
				utcDate: "2025-10-07T21:30:00Z",
				status: "PENDING",
				finalResult: null,
			},
		},
