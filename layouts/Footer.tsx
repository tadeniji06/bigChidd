				...
				<div className='py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
					...
					<div className='lg:col-span-2'>
						...
						<p className='text-main mb-6 max-w-md leading-relaxed'>
							At BigChidd.com, we’re committed to helping you stay
							ahead of the bookies. With a strong belief in teamwork
							and strategy, we know that together, success is always
							within reach. We offer expert betting tips across a wide
							range of sports — including football, tennis,
							basketball, horse racing, baseball, table tennis,
							cycling, motorsport, dog racing, handball, and hockey.
							Our predictions are backed by in-depth analysis,
							advanced algorithms, and relevant statistics to give you
							the winning edge.
						</p>
				...
				<div className='border-t border-gray-200 py-6'>
					<div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
						<p className='text-gray-500 text-sm text-center md:text-left'>
							© {currentYear} BigChidd. All rights reserved.
						</p>
